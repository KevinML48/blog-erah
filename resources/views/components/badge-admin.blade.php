...
{{--     class="icon icon-tabler icons-tabler-outline icon-tabler-diamond inline-block ml align-super">--}}
...
{{-- An emoji --}}
<span class="text-s align-super">👑</span>

{{-- An Image--}}
{{--<img src="{{ asset('storage/images/erah.png') }}" alt="Flourish Icon" class="inline-block ml-1 h-4 align-super">--}}
