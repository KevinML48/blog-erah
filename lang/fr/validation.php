...
return [
    ...
    */
    ...
    | les lignes. Cela permet de spécifier rapidement une ligne de message
    ...
    */
    ...
    'custom' => [
        'post' => [
            'published' => 'On ne peut pas modifier la date d\'un post déjà publié.'
        ],
        'username' => [
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes sont utilisées pour échanger l’espace réservé des
    | attributs par quelque chose de plus lisible, comme "Adresse E-Mail"
    | au lieu de "email". Cela nous aide simplement à rendre le message
    | plus expressif.
    |
    */
